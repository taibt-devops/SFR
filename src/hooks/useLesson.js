...
import { loadCourse, saveCourse, purgeLegacy, streakFor, doneToday, recordSaid, saidFor, recentDays, weekDays, weekCount, learnedWords } from "../srs/course.js";
...
export function useLesson() {
  ...
  return {
    ...
    wordCount: learnedWords(lessons, progress, myWords).length,
